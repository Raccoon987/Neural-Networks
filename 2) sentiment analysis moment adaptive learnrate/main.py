...
def main():
    lst = [1768, 1555, 894, 674, 65, 54, 137, 327, 354, 492, 553, 634, 844, 928, 1054, 1118, 1228, 1449, 1474, 1483, 1504, 
           1529, 1559, 1733, 1881, 1917]
    ...
    #layer_sequence = [(10, 10, 10, 10), (30, 30, 30, 30), (100, 100, 100, 100), (300, 300, 300, 300), (10, 30, 100, 300), 
    #                  (300, 100, 30, 10), (500, 150, 20, 2), (1000, 300, 30, 4), (400, 100, 20, 10)]
    ...
    X, Y = vectorizer( np.append(np.array(data[0]["text"]), np.array(data[1]["text"])), 
                       tokenizer=tokenize, 
                       ngram_range=(1, 3), 
                       max_df=0.85, 
                       min_df=1, 
